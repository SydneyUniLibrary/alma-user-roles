...
class RestPurchaseRequests(object):
    ...
    def __init__(self):  # noqa: E501
        """RestPurchaseRequests - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RestPurchaseRequests, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RestPurchaseRequests):
            return False
