...
class RestUserDeposits(object):
    ...
    def __init__(self):  # noqa: E501
        """RestUserDeposits - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RestUserDeposits, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RestUserDeposits):
            return False
