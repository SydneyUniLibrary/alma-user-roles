...
class UserStatistic2(object):
    ...
    def __init__(self, segment_type=None, statistic_category=None, category_type=None, statistic_note=None):  # noqa: E501
        """UserStatistic2 - a model defined in Swagger"""  # noqa: E501
    ...
    def segment_type(self):
        """Gets the segment_type of this UserStatistic2.  # noqa: E501
        ...
        :return: The segment_type of this UserStatistic2.  # noqa: E501
        :rtype: str
        """
    ...
    def segment_type(self, segment_type):
        """Sets the segment_type of this UserStatistic2.

        The type of the segment (Internal or External). Relevant only for User API (and not for SIS). For internal users, all the segments are considered internal. External users might have internal or external segments. Empty or illegal segment_type for external user will be considered as external.  # noqa: E501

        :param segment_type: The segment_type of this UserStatistic2.  # noqa: E501
        :type: str
        """
    ...
    def statistic_category(self):
        """Gets the statistic_category of this UserStatistic2.  # noqa: E501
        ...
        :return: The statistic_category of this UserStatistic2.  # noqa: E501
        :rtype: object
        """
    ...
    def statistic_category(self, statistic_category):
        """Sets the statistic_category of this UserStatistic2.

        The statistic's Categories. Possible codes are listed in 'User Statistical Categories' [code table](https://developers.exlibrisgroup.com/blog/Working-with-the-code-tables-API).  # noqa: E501

        :param statistic_category: The statistic_category of this UserStatistic2.  # noqa: E501
        :type: object
        """
    ...
    def category_type(self):
        """Gets the category_type of this UserStatistic2.  # noqa: E501
        ...
        :return: The category_type of this UserStatistic2.  # noqa: E501
        :rtype: object
        """
    ...
    def category_type(self, category_type):
        """Sets the category_type of this UserStatistic2.

        The statistic's type. Possible codes are listed in 'User Category Types' [code table](https://developers.exlibrisgroup.com/blog/Working-with-the-code-tables-API). Output parameter.  # noqa: E501

        :param category_type: The category_type of this UserStatistic2.  # noqa: E501
        :type: object
        """
    ...
    def statistic_note(self):
        """Gets the statistic_note of this UserStatistic2.  # noqa: E501

        The statistic's related note.  # noqa: E501

        :return: The statistic_note of this UserStatistic2.  # noqa: E501
        :rtype: str
        """
    ...
    def statistic_note(self, statistic_note):
        """Sets the statistic_note of this UserStatistic2.

        The statistic's related note.  # noqa: E501

        :param statistic_note: The statistic_note of this UserStatistic2.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserStatistic2, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserStatistic2):
            return False
